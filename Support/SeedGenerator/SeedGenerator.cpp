...
int main()
{
   ...
   //std::vector<std::int32_t> p2({ 30,100,300,1000,3000,10000,30000,100000,300000,1000000 });
   std::vector<std::int32_t> p2({ /*1000000, 300000, */ 100000, 30000, 10000, 3000, 1000, 300, 100, 30, 10, 3 });
   ...
   //for (auto pp1 : p1)
      for (auto pp2 : p2)
         for (std::uint32_t s : seeds)
            std::cout << std::dec << /* pp1 << "   " << */ pp2 << "   0x" << std::hex << std::setw(8) << s << std::endl;
}
